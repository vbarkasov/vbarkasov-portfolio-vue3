...
export default {
  setup () {
    ...
    return {
      paymentMethods, contacts, showPopup
    }
  }
}
</script>
...
<style>
  ...
  .vb-icon {
    ...
    vertical-align: top;
    background: url("/static/img/icons-sprite.png") 0 0 no-repeat;
    text-indent: -5000px;
    width: 52px;
    height: 52px;
    opacity: 0.6;
  ...
  .vb-icon.telegram {
    background-image: url('data:image/svg+xml;base64,');
